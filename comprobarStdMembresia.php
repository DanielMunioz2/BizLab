        ...
        if($_SESSION["tipoUsuario"] == "Miembro"){
            ...
            if(isset($_POST["verifiMembresiaEstd"])){
                ...
                $resultadoMembresia = $conn->query(
                    "SELECT `membreIdEpayco`, `membreId`, `membreCodEpayco`, `membreCodigo` FROM `soqkyjmy_bizclubPlataformaDb`.`membresiauser`
                ...
                $resultadoMembreDatos = $conn->query(
                    "SELECT * FROM `soqkyjmy_bizclubPlataformaDb`.`membresias`
